\begin{longtable}{D E E}
	...
	\rowcolor{lightgray}
	Distance de Levenshtein & Cet algorithme de calcul de distance entre chaînes de caractères  n'est pas un outil d'\ac{ia}, mais représente une solution utile pour comparer du langage & Repérage des doublons ou variantes orthographiques au sein d’un thésaurus ; facilite l’harmonisation des vocabulaires. \\
