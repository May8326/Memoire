...
\begin{document}
	...
	\printbibliography[keyword={texHistoire}, notkeyword={dontcite}, title={Histoire du musée de l'air et de l'espace}]
	\printbibliography[keyword={texCollab}, notkeyword={dontcite}, title={Collaboration entre institutions patrimoniales}]
	\printbibliography[keyword={texNumeriquePatrimoine}, notkeyword={dontcite}, title={Numérique en institution patrimoniale}]
	\printbibliography[keyword={texArchivesNumeriques}, notkeyword={dontcite}, title={Archives Numériques}]
	\printbibliography[keyword={texThesau}, notkeyword={dontcite}, title={Gestion de thésaurus}]
	\printbibliography[keyword={reflexions}, notkeyword={dontcite}, title={Références littéraires}]
	...
	\lettrine{C}{ette} situation révèle de nombreuses contraintes, internes liées à l'histoire du musée et externes dans ses tutelles ministérielles, qui font que l'institution a rarement eu dans son histoire l'occasion de raisonner la création et l'enrichissement de son vocabulaire à l'échelle globale du musée. De plus, le cas de la migration vers la plateforme \gls{clade} illustre parfaitement comment cette tâche met en jeu de nombreux acteurs et implique bien plus que les seuls usagers de ces vocabulaires : elle engage l'ensemble de l'écosystème documentaire et muséal dans lequel s'inscrit le \maelong et fait de la gestion terminologique un enjeu dépassant largement les seules préoccupations internes de l'établissement.
