...
\newcolumntype{Z}{>{\raggedright\arraybackslash}X[2]}
...
\chapter[Frise du MAE]{Frise historique du musée de l'air et de l'espace}

%\input{./backmatter/annexes/A1_frise.tex}
