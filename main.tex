...
\addbibresource{biblio.bib} %le fichier bibliograhique. Exemple de chemin à partir du dossier où se trouve le document maître:Exemple ./dossierA/fichier.bib
...
\chapter{Une référence nationale pour les collections aéronautiques}
\input{par1chap1.tex} %Input: importer un fichier
