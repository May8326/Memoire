...
\usepackage[colorlinks=false, breaklinks=true, pdfusetitle, pdfsubject ={La gestion de l'information à l'ère du numérique}, pdfkeywords={Musée de l’Air et de l’Espace~; gouvernance de l’information~; thésaurus documentaire~; modélisation de données~; interopérabilité~; musée technique~; archives numériques~; normalisation~; métiers des musées~; sensibilisation~; structuration des connaissances}]{hyperref} %
...
\begin{document}
	...
	\chapter[Requêtes SPARQL]{\label{Ax-J}Méthode d'extraction de données Wikidata pour la constitution d'une base de données aéronautiques de référence}
