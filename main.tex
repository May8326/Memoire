...
\appto\frontmatter{\pagestyle{fancy}%
	\renewcommand{\chaptermark}[1]{\markright{\small\textit{#1}}{}}% ne pas faire apparaître de <<numéro>> de chapitre dans les chapitres non numérotés (front: l'introduction, els remerciement, etc)
}
...
\chapter[Chronologie du MAE]{\label{Ax-A}Chronologie du musée de l'air et de l'espace}
