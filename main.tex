...
\appto\frontmatter{\pagestyle{fancy}%
	\renewcommand{\sectionmark}[1]{\markright{\small\textit{#1}}{}}% ne pas faire apparaître de <<numéro>> de chapitre dans les chapitres non numérotés (front: l'introduction, els remerciement, etc)
}
