...
\reponse{[Un responsable de la base de donnée] s'en occupe. Notre thésaurus est peut-être plus intéressant pour les avions récents.}

\question{D'où viennent les données des thésaurus ? Qui les saisit ? Qui les valide ?}

\reponse{Les documentalistes font des propositions de candidats en cataloguant, [le responsable] s'occupe de les valider pour les intégrer au thésaurus.}
...
\reponse{[Un documentaliste] fait des ajouts en tant que candidat, puis [le responsable] valide et ajoute. Pour les avions, [il] vérifie par rapport aux ouvrages de référence.}

\question{Où sont-elles hébergées ?}

\reponse{Le prestataire stocke les données. Une autre prestation assure la maintenance de la base et du logiciel de l'e-médiathèque.}
