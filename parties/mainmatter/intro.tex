...
% AJOUT RAPIDE DE DEFINITIONS DE BASE : thésaurus, information, données, base de données, gouvernance de l'information...

% mention de la gouvernance de l'information dans les TIC et justification de pourquoi pas plus mentionné dans le devoir.
