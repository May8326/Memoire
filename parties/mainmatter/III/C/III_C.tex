...
\lettrine{A}{insi}, la mise en œuvre de solutions automatisées pour la gestion des vocabulaires et des archives numériques au \mae~ne saurait se substituer à l’expertise et à la concertation des métiers. Les recherches et les quelques expérimentations menées montrent que l'\ac{ia} peut être un auxiliaire précieux capable d’accélérer le traitement de volumes importants de données~: elle impose cependant une vigilance accrue sur la qualité des résultats et la préservation du sens. L'avenir de la gouvernance documentaire au \mae~ -- et, il semble également dans toute institution patrimoniale -- repose ainsi sur une articulation équilibrée entre innovation technique et savoir-faire métier.