...
Par exemple, la gestion ministérielle du projet, bien qu'ayant offert au musée une occasion unique de modernisation de ses outils, a pu occasionner des difficultés de visibilité sur le déroulement de la migration. Le cahier des charges du projet a été négocié pour l'ensemble des \bibmusee~ au début du projet, au niveau du ministère et ces-derniers n'y ont pas eu accès.

Par exemple, la gestion ministérielle du projet, bien qu'ayant offert au musée une occasion unique de modernisation de ses outils, a pu occasionner des difficultés de visibilité sur le déroulement de la migration. En effet, cette migration de grande ampleur, qui a concerné l'ensemble des \bibmusee, s'est déroulé sur plusieurs années. Étant en bout de chaîne de production, il existait donc au moment de la migration un décalage entre les pratiques -- qui ont évolué au cours du temps -- et les négociations initiales du cahier des charges. Ces circonstances complexifient toute anticipation d'éventuels problèmes pendant la migration~: ce n'est ainsi qu'à la fin de la phase de test qu'a été découvert que la structure du fichier d'import du thésaurus avait été mal comprise par les responsables de la migration des données, causant des inexactitudes lors de l'import, difficiles à corriger \textit{a posteriori}.
